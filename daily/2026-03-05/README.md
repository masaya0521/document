...
| # | トピック | 概要 | ソース |
|---|---------|------|--------|
| 1 | Apple MacBook Neo・M5チップ搭載Mac発表 | Appleが3月イベントでMacBook Neo（低価格ノートPC）、M5搭載MacBook Air（$1,099〜）、M5 Pro/Max搭載MacBook Pro（$1,699〜）を発表。iPhone 17e（$599）やiPad Air M4も先行発表済み。 | [Tom's Guide](https://www.tomsguide.com/news/live/apple-march-event-2026-live) |
| 2 | ChatGPTアンインストール295%急増 — OpenAI国防総省契約への反発 | OpenAIが国防総省との契約を締結したことで、ChatGPTアプリのアンインストールが295%急増。1つ星レビューも775%増加。Sam Altmanは契約条件を修正し国内監視への使用を制限する保証を追加。 | [TechCrunch](https://techcrunch.com/2026/03/02/chatgpt-uninstalls-surged-by-295-after-dod-deal/) |
| 3 | Nvidia、フォトニクス企業に40億ドル投資 | NvidiaがCoherentとLumentumに各20億ドルを投資。AI基盤の次世代光学コンポーネント確保に向けた複数年の購入契約を締結。シリコンフォトニクスの共同開発も進める。 | [CNBC](https://www.cnbc.com/2026/03/02/nvidia-investment-coherent-lumentum.html) |
| 4 | OpenAI GPT-5.3 Instant リリース | OpenAIがGPT-5.3 Instantをリリース。会話の流れ、回答の関連性、Web検索結果の改善に重点を置いたアップデート。 | [LLM Stats](https://llm-stats.com/ai-news) |
| 5 | Alibaba Qwen3.5シリーズ公開 | Qwen3.5-4B（マルチモーダル軽量エージェント向け、262Kトークンコンテキスト）とQwen3.5-9B（OpenAIのgpt-oss-120Bを上回る推論モデル）をApache 2.0ライセンスで公開。 | [LLM Stats](https://llm-stats.com/llm-updates) |
| 6 | Cisco SD-WAN重大ゼロデイ脆弱性（CVE-2026-20127） | CVSS 10.0の最大深刻度の脆弱性が2023年から悪用されていたことが判明。認証バイパスにより管理者権限を取得可能。CISAがKEVカタログに追加し、24時間以内の修正を義務化。 | [The Hacker News](https://thehackernews.com/2026/02/cisco-sd-wan-zero-day-cve-2026-20127.html) |
| 7 | Google、中国のGRIDTIDEサイバースパイ活動を阻止 | GoogleがUNC2814として追跡される中国関連の脅威アクターによる42カ国53組織への攻撃を阻止。GRIDTIDEマルウェアはGoogle Sheets APIをC2通信に悪用していた。 | [The Hacker News](https://thehackernews.com/2026/02/google-disrupts-unc2814-gridtide.html) |
| 8 | Anthropic、国防総省との契約拒否でサプライチェーンリスク指定 | Anthropicが国防総省との契約を倫理的理由で拒否した結果、トランプ政権からサプライチェーンリスクに指定。200社超のVC投資家からの600億ドルの投資が影響を受ける可能性。 | [Radical Data Science](https://radicaldatascience.wordpress.com/2026/03/04/ai-news-briefs-bulletin-board-for-march-2026/) |
| 9 | Google Pixel March 2026 Feature Drop | Android 16 QPR3アップデートでAI生成カスタムアイコン機能を追加。Scribbles、Cookies、Easel等のスタイルでホーム画面アイコンをカスタマイズ可能に。 | [9to5Google](https://9to5google.com/2026/03/03/march-pixel-2026-feature-drop/) |
| 10 | OSSの持続可能性危機 — Open Source Endowment設立 | OSS資金問題の恒久的解決を目指すNPO「Open Source Endowment」が501(c)(3)認定取得。75万ドル以上のコミットメントを確保。MavenなどのOSSリポジトリも有料化を検討中。 | [TechCrunch](https://techcrunch.com/2026/02/26/a-vc-and-some-big-name-programmers-are-trying-to-solve-open-sources-funding-problem-permanently/) |

## World News

| # | トピック | 概要 | ソース |
|---|---------|------|--------|
| 1 | 米国・イスラエルのイラン攻撃が5日目に突入 | 2月28日に始まった米国・イスラエルのイラン共同攻撃が5日目に。イラン最高指導者ハメネイ師が死亡。イランはミサイル・ドローンで報復し、死者1,045人に達する。 | [Al Jazeera](https://www.aljazeera.com/news/2026/3/4/israel-iran-continue-attacks-as-war-enters-its-fifth-day-engulfs-region) |
| 2 | 原油価格急騰 — ホルムズ海峡の混乱 | ブレント原油が一時13%上昇し82ドル/バレル超に。世界の石油・LNGの約20%が通過するホルムズ海峡で約150隻が足止め。ドバイのジュベル・アリ港も操業停止。 | [World Economic Forum](https://www.weforum.org/stories/2026/03/us-trade-deficit-international-trade-stories-march-2026/) |
| 3 | 米軍兵士4名がイラン紛争で死亡 | イランとの軍事衝突で米兵4名の死亡が確認。トランプ大統領は追加の犠牲者が出る可能性を示唆。3つの米大使館が閉鎖。 | [Washington Post](https://www.washingtonpost.com/world/2026/03/03/us-iran-israel-military-strikes-trump-live-updates/) |
| 4 | 中東紛争でテック企業に影響 — NvidiaやAmazonがドバイ拠点閉鎖 | Nvidiaがドバイオフィスを一時閉鎖、Amazonも中東の全企業オフィスを閉鎖。Googleの従業員も足止め状態に。 | [CNBC](https://www.cnbc.com/2026/03/03/nvidia-amazon-offices-google-dubai-iran-war.html) |
| 5 | 米国株式市場反発 — S&P 500が0.78%上昇 | 経済指標の好調を受けて反発。ダウ+238pt（48,739）、S&P500+0.78%（6,869）、ナスダック+1.29%。ADP雇用統計が予想上回る。 | [Bloomberg](https://www.bloomberg.com/news/articles/2026-03-04/stock-market-today-dow-s-p-live-updates-) |
| 6 | レバノンへのイスラエル空爆で50人死亡 | イスラエルによるレバノンへの空爆で少なくとも50人が死亡、335人が負傷。中東紛争の拡大が懸念される。 | [CNN](https://www.cnn.com/world/live-news/iran-war-us-israel-trump-03-04-26) |
| 7 | CISA人員削減 — イランのサイバー脅威増大の中で | 米サイバーセキュリティ機関CISAがトランプ政権下で職員の約3分の1を失い、イラン関連のサイバー攻撃脅威が増大する中で機能低下の懸念。 | [CNBC](https://www.cnbc.com/2026/03/03/iran-cisa-cybersecurity-war-threat.html) |
| 8 | インド・EU自由貿易協定が発効 | インドとEUが画期的な自由貿易協定を締結。20億人・世界GDPの25%近くをカバーする世界最大の自由貿易圏が誕生。 | [World Economic Forum](https://www.weforum.org/stories/2026/03/us-trade-deficit-international-trade-stories-march-2026/) |
